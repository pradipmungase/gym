                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="#" id="forgotPasswordForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="tel" class="form-control form-control-lg" name="mobile" id="mobile"
                                    tabindex="1" placeholder="Mobile Number" aria-label="Mobile Number" required
                                    maxlength="10" pattern="\d{10}" title="Enter a valid 10-digit mobile number"
                                    value="{{ old('mobile') ?? '7028143227' }}">
                    ...
                    <div class="modal-body px-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" maxlength="4" minlength="4" class="form-control" id="otp" name="otp" required placeholder="e.g., 1234">
                                <div id="otpErrorMsg" class="text-danger mb-2" style="display: none;"></div>
                                <br>
                                <div class="text-end mt-2">
                                  <span id="resendOtpTimer" class="text-muted"></span>
                                  <a href="#" id="resendOtpBtn" onclick="resendOtp()" class="text-primary text-decoration-none ms-2 d-none">Resend Reset OTP</a>
                              </div>
