...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('Website/assets/img/favicons/favicon.png') }}">
    <link rel="stylesheet" crossorigin="anonymous"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"
        integrity="sha512-HK5fgLBL+xu6dm/Ii3z4xhlSUyZgTT9tuc/hSrtw6uzJOvgRr2a9jyxxT1ely+B+xFAmJKVSTbpM/CuL7qxO8w==">
    <link href="{{ asset('Website/assets/css/theme.css') }}" rel="stylesheet" />
    <link href="https://themewagon.github.io/Safia/v1.0.1/vendors/swiper/swiper-bundle.min.css" rel="stylesheet">
</head>
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-light sticky-top" data-navbar-darken-on-scroll="900"
            ...
            <div class="container pt-2"><a class="navbar-brand" href="#">
                    <h1>GYM Manager</h1>
                </a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-9 col-lg-8 col-xl-5">
                        <h1 class="display-3 lh-sm">Powerful Gym Management Portal</h1>
                    </div>
                    <div class="col-md-9 col-xl-5">
                        <p class="fs-2">
                            Streamline your fitness center with our all-in-one gym management solution — track
                            memberships, manage schedules, handle payments, and more, all from one dashboard.
                        </p>
                        <button class="btn btn-primary mt-3">Explore Features & Pricing</button>
                    </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="container"><img class="img-fluid" src="{{ asset('logo/Screenshot 2025-04-22 014534.png') }}"
                    alt="Dashboard" />
            </div>
            <!-- end of .container-->
        ...
        <section>
            ...
            <div class="container">
                <div class="row mx-md-5 px-md-5 d-flex justify-content-evenly">
                    <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img
                            src="{{ asset('Website/assets/img/gallery/brands/google.png') }}" alt="Google"
                            style="height:30px;" /></div>
                    <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img
                            src="{{ asset('Website/assets/img/gallery/brands/slack.png') }}" alt="Slack"
                            style="height:30px;" /></div>
                    <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img
                            src="{{ asset('Website/assets/img/gallery/brands/amazon.png') }}" alt="Amazon"
                            style="height:30px;" /></div>
                    <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img
                            src="{{ asset('Website/assets/img/gallery/brands/zoom.png') }}" alt="Zoom"
                            style="height:30px;" /></div>
                    <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img
                            src="{{ asset('Website/assets/img/gallery/brands/netflix.png') }}" alt="Netflix"
                            style="height:30px;" /></div>
                </div>
        ...
        <section>
            ...
            <div class="container">
                ...
                <p class="fs-2">Manage your gym efficiently with smart tools for tracking attendance, communication,
                ...
                <div class="row mb-4 mt-6">
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/dashboardicon.png') }}" alt="Dashboard"
                                    style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">Dashboard Overview</h3>
                                <p class="mb-0">Get a complete snapshot of your gym’s performance, member activity,
                                    and daily operations from one central dashboard.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/statistics.png') }}" alt="Statistics"
                                    style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">Attendance Tracking</h3>
                                <p class="mb-0">Track member check-ins, monitor attendance trends, and manage class
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/location.png') }}" alt="Location"
                                    style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">Location-Based Check-in</h3>
                                <p class="mb-0">Allow members to check in automatically when they arrive at the gym,
                                    using GPS or QR scan technology.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/communication.png') }}"
                                    alt="Communication" style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">WhatsApp & SMS Alerts</h3>
                                <p class="mb-0">Send automated reminders, payment alerts, and updates via WhatsApp or
                                    text message to keep your members informed.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/profile.png') }}"
                                    alt="Member Profiles" style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">Member Profiles</h3>
                                <p class="mb-0">Maintain detailed member records including attendance, progress,
                                    payments, and communication logs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border rounded-1 border-700 h-100 features-items">
                            <div class="p-5">
                                <img src="{{ asset('Website/assets/img/gallery/folder.png') }}" alt="Reports"
                                    style="width:48px;height:48px;" />
                                <h3 class="pt-3 lh-base">Reports & Analytics</h3>
                                <p class="mb-0">Generate performance reports, attendance summaries, and revenue
                                    insights to optimize your gym’s workflow.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <div class="p-5 bg-primary rounded-3">
                        <div class="py-3">
                            ...
                            <h2 class="mt-3 fs-4 fs-sm-7 latter-sp-3 lh-base fw-semi-bold">Start Your Free Trail Today
                            </h2>
                        </div>
        ...
        <section class="mt-5">
            ...
            <div class="container">
                ...
                <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
                    <div class="col-md-7 col-lg-6 order-md-1"><img class="w-100"
                            src="{{ asset('Website/assets/img/gallery/comment1.png') }}" alt="..." /></div>
                    <div class="col-md-5 col-lg-4">
                        <h3 class="fs-xl-7 fs-lg-4 fs-md-3 mt-5 mt-md-0">How does it work?</h3>
                        <p class="fs-xl-1 ls-3 pe-xl-2"> Our landing page template works on all devices, so you only
                            have to set it up once, and get beautiful results.</p>
                    </div>
                </div>
                <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
                    <div class="col-md-7 col-lg-6 false"><img class="w-100"
                            src="{{ asset('Website/assets/img/gallery/comment2.png') }}" alt="..." /></div>
                    <div class="col-md-5 col-lg-4">
                        <h3 class="fs-xl-7 fs-lg-4 fs-md-3 mt-5 mt-md-0">How does it work?</h3>
                        <p class="fs-xl-1 ls-3 pe-xl-2"> Our landing page template works on all devices, so you only
                            have to set it up once, and get beautiful results.</p>
                ...
                <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
                    <div class="col-md-7 col-lg-6 order-md-1"><img class="w-100"
                            src="{{ asset('Website/assets/img/gallery/comment3.png') }}" alt="..." /></div>
                    <div class="col-md-5 col-lg-4">
                        <h3 class="fs-xl-7 fs-lg-4 fs-md-3 mt-5 mt-md-0">How does it work?</h3>
                        <p class="fs-xl-1 ls-3 pe-xl-2"> Our landing page template works on all devices, so you only
                            have to set it up once, and get beautiful results.</p>
                ...
                <div class="row flex-center">
                    <div class="col-sm-9 col-md-4 mt-3">
                        <div class="py-5 px-4 px-md-3 px-lg-4 rounded-1 bg-800 plans-cards mt-md-9">
                            ...
                            <ul class="mt-5 ps-0">
                                <li class="pricing-lists"><i
                                        class="fas fa-check-circle fa-lg me-2 text-600"></i>7,000,000+ Events</li>
                                <li class="pricing-lists"><i class="fas fa-check-circle fa-lg me-2 text-600"></i>4
                                    Custom Domains</li>
                                <li class="pricing-lists"><i
                                        class="fas fa-check-circle fa-lg me-2 text-600"></i>Dedicated Support </li>
                                <li class="pricing-lists"><i class="fas fa-check-circle fa-lg me-2 text-600"></i>12
                                    Months History</li>
                                <li class="pricing-lists"><i class="fas fa-check-circle fa-lg me-2 text-600"></i>1
                                    Dedicated SSL</li>
                            </ul>
                            <button class="btn btn-gray mt-4">Get Started <span
        ...
        <section class="bg-secondary">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 text-center text-xl-start"><a href="#!"><img
                                class="footer-img me-xl-5 me-3"
                                src="{{ asset('Website/assets/img/gallery/facebook-line1.svg') }}" alt="fb"
                                style="width:20px;height:20px;" /></a><a href="#!"><img
                                class="footer-img me-xl-5 me-3"
                                src="{{ asset('Website/assets/img/gallery/linkedin-line1.svg') }}" alt="in"
                                style="width:20px;height:20px;" /></a><a href="#!"><img
                                class="footer-img me-xl-5 me-3"
                                src="{{ asset('Website/assets/img/gallery/twitter-line1.svg') }}" alt="twitter"
                                style="width:20px;height:20px;" /></a><a href="#!"><img
                                class="footer-img me-xl-5 me-3"
                                src="{{ asset('Website/assets/img/gallery/instagram-line1.svg') }}    "
                    ...
                    <div class="col-xl-4 pt-2 pt-xl-0">
                        <p class="mb-0 text-center text-xl-end"><a class="text-300 text-decoration-none footer-link"
                                ...
                                class="text-300 text-decoration-none footer-link ps-4" href="#!">Privacy Policy
                            </a>
                        </p>
                    </div>
                    <div class="col-xl-5 pt-2 pt-xl-0 text-center text-xl-end">
                        <p class="mb-0">&copy;GYM Manager ❤️ Made in India</p>
                    </div>
                </div>
            </div>
            <!-- end of .container-->
    ...
    <script src="{{ asset('Website/vendors/swiper/swiper-bundle.min.js') }}"></script>
