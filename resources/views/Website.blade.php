    ...
    <header id="header"
        ...
        <div class="container-lg">
            <nav class="js-mega-menu navbar-nav-wrap">
                ...
                <a class="navbar-brand" href="{{ url('/') }}" aria-label="" style="max-width: unset !important;">
                    <img class="navbar-brand-logo" src="{{ asset('assets/images/BlackFullLogo.png') }}" alt="Logo"
                        data-hs-theme-appearance="default">
                    <img class="navbar-brand-logo" src="{{ asset('assets/images/WhiteFullLogo.png') }}" alt="Logo"
            ...
            <div class="w-md-75 w-lg-50 mx-md-auto mb-5 mb-md-9">
                ...
                <div class="text-center mb-7">
                    <p>Not comfortable diving that deep? No worries, you just use the compiled CSS and examples pages!
                        <a class="link" href="./documentation/gulp.html">Learn more <i
                                class="bi-chevron-right small"></i></a></p>
                </div>

                <div class="row justify-content-center">
                    <div class="col-auto col-sm-3 col-sm py-3">
                        <img class="avatar avatar-xl avatar-4x3"
                            src="{{ asset('assets/images/Demo/DarkDashboard.png') }}" alt="Logo">
                    </div>
                    <!-- End Col -->
