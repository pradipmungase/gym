...
<body>
    ...
    <section class="about-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-pic">
                        <img src="{{ asset('Website/img/about-pic.jpg') }}" alt="">
                        <a href="https://www.youtube.com/watch?v=SlPhMPnQ58k" class="play-btn video-popup">
                            <img src="{{ asset('Website/img/play.png') }}" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-pic">
                        <img src="{{ asset('Website/img/services/service-pic.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="services-item bg-gray">
                                    <img src="{{ asset('Website/img/services/service-icon-1.png') }}" alt="">
                                    <h4>Strategies</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                                <div class="services-item bg-gray pd-b">
                                    <img src="{{ asset('Website/img/services/service-icon-3.png') }}" alt="">
                                    <h4>Workout</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="services-item">
                                    <img src="{{ asset('Website/img/services/service-icon-2.png') }}" alt="">
                                    <h4>Yoga</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                                <div class="services-item pd-b">
                                    <img src="{{ asset('Website/img/services/service-icon-4.png') }}" alt="">
                                    <h4>Weight Loss</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('Website/img/trainer/trainer-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('Website/img/trainer/trainer-2.jpg') }}" alt="">
                        <div class="trainer-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="{{ asset('Website/img/trainer/trainer-3.jpg') }}" alt="">
                        <div class="trainer-text">
                            <h5>Walter Wagner</h5>
    ...
    <section class="banner-section set-bg" data-setbg="img/banner-bg.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <img src="{{ asset('Website/img/banner-person.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="footer-section">
        <div class="container">
            ...
            <div class="subscribe-option set-bg" data-setbg="{{ asset('Website/img/footer-signup.jpg') }}    ">
                <div class="so-text">
