  ...
  <header id="header" class="navbar navbar-expand-lg navbar-center navbar-light bg-white navbar-absolute-top navbar-show-hide" data-hs-header-options='{
    ...
    <div class="container-lg">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="{{ url('/') }}" aria-label="Front" style="max-width: unset !important;">
          <img class="navbar-brand-logo" src="{{ asset('assets/images/blackFullLogo.png') }}" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo" src="{{ asset('assets/images/blackFullLogo.png') }}" alt="Logo" data-hs-theme-appearance="dark">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarContainerNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link py-2 py-lg-3" href="Home">Home</a>
            </li>
                        <li class="nav-item">
              <a class="nav-link py-2 py-lg-3" href="Home">About Us</a>
            </li>
                        <li class="nav-item">
              <a class="nav-link py-2 py-lg-3" href="Home">Contact Us</a>
            </li>
          </ul>
        </div>
        <!-- End Collapse -->
            ...
            <div class="position-relative">
              ...
              <div class="device-browser-frame">
                <div class="js-img-comp-container hs-img-comp-container">
                  <img class="hs-img-comp hs-img-comp-a" src="{{ asset('/logo/Dark.png') }}" alt="Image Description">

                  <div class="js-img-comp-wrapper hs-img-comp-wrapper">
                    <img class="hs-img-comp hs-img-comp-b" src="{{ asset('/logo/White.png') }}" alt="Image Description">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7 mb-4 mb-md-0">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" src="{{ asset('logo/Screenshot 2025-01-21 192252.png') }}" alt="Image Description" data-hs-theme-appearance="default">
              <img class="img-fluid" src="{{ asset('logo/Screenshot 2025-01-21 192252.png') }}" alt="Image Description" data-hs-theme-appearance="dark">
            </div>
          </div>
          <!-- End Card -->
        </div>
