  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-light sticky-top" data-navbar-darken-on-scroll="900">
        <div class="container pt-2"><a class="navbar-brand" href="#"> <img src="{{ asset('logo/1.jpg') }}" alt="..." /></a>
      ...
      <section>
        ...
        <div class="container"><img class="img-fluid" src="{{ asset('Website/assets/img/gallery/dashboard.png') }}" alt="Dashboard" />
        </div>
        <!-- end of .container-->
      ...
      <section>
        ...
        <div class="container">
          <div class="row mx-md-5 px-md-5 d-flex justify-content-evenly">
            <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img src="{{ asset('Website/assets/img/gallery/brands/google.png') }}" alt="Google" style="height:30px;" /></div>
            <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img src="{{ asset('Website/assets/img/gallery/brands/slack.png') }}" alt="Slack" style="height:30px;" /></div>
            <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img src="{{ asset('Website/assets/img/gallery/brands/amazon.png') }}" alt="Amazon" style="height:30px;" /></div>
            <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img src="{{ asset('Website/assets/img/gallery/brands/zoom.png') }}" alt="Zoom" style="height:30px;" /></div>
            <div class="col-4 col-lg-auto mt-5 mt-lg-0"><img src="{{ asset('Website/assets/img/gallery/brands/netflix.png') }}" alt="Netflix" style="height:30px;" /></div>
          </div>
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row mb-4 mt-6">
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/dashboardicon.png') }}" alt="Dashboard" style="width:48px;height:48px;" />
            ...
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/comment.png') }}" alt="Comment" style="width:48px;height:48px;" />
          ...
          <div class="row mb-4">
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/trilored.png') }}" alt="Tailored" style="width:48px;height:48px;" />
            ...
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/statistics.png') }}" alt="Statistic" style="width:48px;height:48px;" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/profile.png') }}" alt="Profiles" style="width:48px;height:48px;" />
            ...
            <div class="col-md-6">
              <div class="border rounded-1 border-700 h-100 features-items">
                <div class="p-5"><img src="{{ asset('Website/assets/img/gallery/folder.png') }}" alt="Folders" style="width:48px;height:48px;" />
      ...
      <section class="mt-5">
        ...
        <div class="container">
          ...
          <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
            <div class="col-md-7 col-lg-6 order-md-1"><img class="w-100" src="{{ asset('Website/assets/img/gallery/comment1.png') }}" alt="..." /></div>
          ...
          <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
            <div class="col-md-7 col-lg-6 false"><img class="w-100" src="{{ asset('Website/assets/img/gallery/comment2.png') }}" alt="..." /></div>
            <div class="col-md-5 col-lg-4">
              <h3 class="fs-xl-7 fs-lg-4 fs-md-3 mt-5 mt-md-0">How does it work?</h3>
              <p class="fs-xl-1 ls-3 pe-xl-2"> Our landing page template works on all devices, so you only have to set it up once, and get beautiful results.</p>
            </div>
          ...
          <div class="row mt-6 flex-center justify-content-xl-evenly px-xl-5">
            <div class="col-md-7 col-lg-6 order-md-1"><img class="w-100" src="{{ asset('Website/assets/img/gallery/comment3.png') }}" alt="..." /></div>
            <div class="col-md-5 col-lg-4">
              <h3 class="fs-xl-7 fs-lg-4 fs-md-3 mt-5 mt-md-0">How does it work?</h3>
              <p class="fs-xl-1 ls-3 pe-xl-2"> Our landing page template works on all devices, so you only have to set it up once, and get beautiful results.</p>
            </div>
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-3 text-center text-xl-start"><a href="#!"><img class="footer-img me-xl-5 me-3" src="{{ asset('Website/assets/img/gallery/facebook-line1.svg') }}" alt="fb" style="width:20px;height:20px;" /></a><a href="#!"><img class="footer-img me-xl-5 me-3" src="{{ asset('Website/assets/img/gallery/linkedin-line1.svg') }}" alt="in" style="width:20px;height:20px;" /></a><a href="#!"><img class="footer-img me-xl-5 me-3" src="{{ asset('Website/assets/img/gallery/twitter-line1.svg') }}" alt="twitter" style="width:20px;height:20px;" /></a><a href="#!"><img class="footer-img me-xl-5 me-3" src="{{ asset('Website/assets/img/gallery/instagram-line1.svg') }}    " alt="instragram" style="width:20px;height:20px;" /></a>
            </div>
